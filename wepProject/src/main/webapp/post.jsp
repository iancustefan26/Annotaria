    ...
    <div class="bg-white rounded-lg shadow-md max-w-xl mx-auto mb-8">
      ...
      <div class="p-4">
        <div class="flex space-x-4 mb-2">
          <button id="likeButton" class="focus:outline-none" data-post-id="${post.id}">
            <i id="likeIcon" class="far fa-heart text-2xl"></i>
          </button>
          <button id="commentButton" class="focus:outline-none">
        ...
        <!-- Like Count -->
        <div class="mb-2">
          <p id="likeCount" class="font-semibold"><span id="likesNumber">${post.likeCount}</span> likes</p>
        </div>

        <!-- Post Caption -->
        <div class="mb-3">
          <p>
            <span class="font-semibold">User #${post.authorId}</span>
        ...
        <!-- Comments Section -->
        <div id="commentsContainer" class="max-h-60 overflow-y-auto">
        ...
        <div class="mt-3 border-t pt-3">
          <div class="flex">
            <textarea id="commentInput" class="flex-grow border-none bg-transparent focus:outline-none resize-none" placeholder="Add a comment..." rows="1"></textarea>
            <button id="submitComment" class="text-blue-500 font-semibold ml-2">Post</button>
          </div>
        </div>
      </div>
    </div>

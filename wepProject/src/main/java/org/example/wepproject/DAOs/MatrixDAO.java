...
public abstract class MatrixDAO extends AbstractDAO<MatrixCell, Long> {
    ...
    public List<MatrixCell> getMatrixFromFunction(Long userId, int bestFriends, int randomFriends) throws SQLException {
        return executePlsqlFunction(generateGraph, userId, bestFriends, randomFriends);
    }
}
